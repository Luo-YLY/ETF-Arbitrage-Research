...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--components-csv", required=True, type=Path)
...
def main() -> int:
    ...
    etf_quotes, stock_quotes = JsonlSnapshotStore(args.input).to_frames(args.etf_code)
    if etf_quotes.empty:
    ...
    observations = ResearchReplay(feed).run(args.etf_code)
